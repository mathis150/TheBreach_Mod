...
public class BlockTest extends ElementsBreachMod.ModElement {
	@GameRegistry.ObjectHolder("breachmod2:test")
	public static final Block block = null;
	public BlockTest(ElementsBreachMod instance) {
		super(instance, 13);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("breachmod2:test", "inventory"));
	}
