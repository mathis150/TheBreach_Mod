...
public class BlockB860SolSlab extends ElementsBreachMod.ModElement {
	@GameRegistry.ObjectHolder("breachmod2:b860solslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("breachmod2:b860solslab_double")
	public static final Block block_slab_double = null;
	public BlockB860SolSlab(ElementsBreachMod instance) {
		super(instance, 117);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("b860solslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("b860solslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("breachmod2:b860solslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.GROUND);
			setUnlocalizedName("b860solslab");
