...
public class BlockLampmural extends ElementsBreachMod.ModElement {
	@GameRegistry.ObjectHolder("breachmod2:lampmural")
	public static final Block block = null;
	public BlockLampmural(ElementsBreachMod instance) {
		super(instance, 101);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lampmural"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("breachmod2:lampmural", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("lampmural");
