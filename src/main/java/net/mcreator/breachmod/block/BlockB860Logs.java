...
public class BlockB860Logs extends ElementsBreachMod.ModElement {
	@GameRegistry.ObjectHolder("breachmod2:b860logs")
	public static final Block block = null;
	public BlockB860Logs(ElementsBreachMod instance) {
		super(instance, 114);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("b860logs"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("breachmod2:b860logs", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("b860logs");
