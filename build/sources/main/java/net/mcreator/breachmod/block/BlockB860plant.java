...
public class BlockB860plant extends ElementsBreachMod.ModElement {
	@GameRegistry.ObjectHolder("breachmod2:b860plant")
	public static final Block block = null;
	public BlockB860plant(ElementsBreachMod instance) {
		super(instance, 121);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("breachmod2:b860plant", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("b860plant");
			setRegistryName("b860plant");
		}
