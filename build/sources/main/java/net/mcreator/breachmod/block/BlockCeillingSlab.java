...
public class BlockCeillingSlab extends ElementsBreachMod.ModElement {
	@GameRegistry.ObjectHolder("breachmod2:ceillingslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("breachmod2:ceillingslab_double")
	public static final Block block_slab_double = null;
	public BlockCeillingSlab(ElementsBreachMod instance) {
		super(instance, 225);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ceillingslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("ceillingslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("breachmod2:ceillingslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("ceillingslab");
		...
		@Override
		public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) { return new ItemStack(block); }
