...
public class BlockTileFloorSlab extends ElementsBreachMod.ModElement {
	@GameRegistry.ObjectHolder("breachmod2:tilefloorslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("breachmod2:tilefloorslab_double")
	public static final Block block_slab_double = null;
	public BlockTileFloorSlab(ElementsBreachMod instance) {
		super(instance, 38);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tilefloorslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("tilefloorslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("breachmod2:tilefloorslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tilefloorslab");
