...
public class BlockMetalFloorSlab extends ElementsBreachMod.ModElement {
	@GameRegistry.ObjectHolder("breachmod2:metalfloorslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("breachmod2:metalfloorslab_double")
	public static final Block block_slab_double = null;
	public BlockMetalFloorSlab(ElementsBreachMod instance) {
		super(instance, 40);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("metalfloorslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("metalfloorslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("breachmod2:metalfloorslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("metalfloorslab");
